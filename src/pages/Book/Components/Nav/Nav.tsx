                ...
                : <div className="relative">
                    ...
                    <div className={`w-52 ${showModal ? 'show' : 'hide'} h-36 p-3 border border-black bg-rose-500 rounded-xl absolute left-0 top-14`}>
                        <ul className="before:bg-rose-500 modal relative">
                            <li><h2 className="text-xl text-white text-center mb-2 truncate">سلام {username}</h2></li>
                            <hr />
                            <li className="list-disc mt-2 mx-2 text-xl text-white"><Link to={'/dashboard'}><span>داشبورد</span></Link></li>
